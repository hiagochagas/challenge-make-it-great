...
class AchievementsViewModelTest: XCTestCase {
    ...
    func test_create_badge() {
        ...
        _ = sut.createBadge(descriptionBadge: "10 tasks", icon: Data(), name: "badge1", progress: 10, viewContext: mockPersistantContainer.viewContext)
    ...
    func test_update_badge_progress() {
        ...
        guard var badge = sut.createBadge(descriptionBadge: "10 tasks", icon: Data(), name: "badge1", progress: progressBeforeUpdate, viewContext: mockPersistantContainer.viewContext) else { return }
    ...
    func test_update_badge() {
        guard let badge = sut.createBadge(descriptionBadge: "10 tasks", icon: Data(), name: "badge1", progress: 5, viewContext: mockPersistantContainer.viewContext) else {return}
        let badgeAfterUpdate = sut.updateBadge(badge: badge, name: "5 tasks", icon: Data(), descriptionBadge: "badge", progress: 3, viewContext: mockPersistantContainer.viewContext)
    ...
    func test_fetch_badge() {
        ...
        guard let _ = sut.createBadge(descriptionBadge: "10 tasks", icon: Data(), name: "badge1", progress: 5, viewContext: mockPersistantContainer.viewContext) else {return}
