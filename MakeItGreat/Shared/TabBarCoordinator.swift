...
class TabBarCoordinator: NSObject, Coordinator, UITabBarControllerDelegate {
    ...
    func setupTabBar() {
        ...
        homeCoordinator.homeViewController = setupVc(viewController: homeCoordinator.homeViewController, image: UIImage(systemName: "list.bullet.rectangle")!, title: "Lists".localized()) as! HomeViewController
        
        achievementsCoordinator.achievementsViewController = setupVc(viewController: achievementsCoordinator.achievementsViewController, image: UIImage(systemName: "calendar")!, title: "Progress".localized()) as! AchievementsViewController
